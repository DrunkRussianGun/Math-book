...
\index{Матрица!производная} Матрица~$\begin{Vmatrix}
a_1 & a_2 & \ldots & a_n
...
\index{grad} \index{Градиент} \textbf{Градиентом функции $f(x_1, \ldots, x_n)$}, дифференцируемой в точке~$\overline x_0$, называется вектор $\grad f \opbr= (f_{x_1}'(\overline x_0), \ldots, f_{x_n}'(\overline x_0))$.