...
\index{Предел последовательности}\index{Сходимость последовательности} Число~$a$ называется \textbf{пределом последовательности~$(x_n)$}, если
\begin{equation*}
...
Последовательность~$(x_n)$ называется \textbf{ограниченной}, или~\textbf{ограниченной величиной}, если $\exists a > 0 \colon \allowbreak \forall n \in \mathbb N \ |x_n| < a$.
