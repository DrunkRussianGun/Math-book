...
\index{grad}\index{Градиент} \textbf{Градиентом функции $f(x_1, \ldots, x_n)$}, дифференцируемой в точке~$\overline{x_0}$, называется вектор $\grad f \opbr= (f_{x_1}', \ldots, f_{x_n}')$.