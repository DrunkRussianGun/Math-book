...
\index{Экстремум функции} Точки локального минимума и~максимума называются \textbf{точками локального экстремума}.

\begin{theorem}[свойство локального экстремума]
Если $x_0$~--- точка локального экстремума функции~$f(x)$, то $\lefteqn{\!\not}\exists f'(x_0)$ или~$f'(x_0) = 0$.
\end{theorem}
\begin{proof}
...
\index{Критическая точка функции} Точка, в~которой производная функции не~существует или~равна нулю, называется \textbf{критической}.
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		По~\hyperref[th:Taylor's_formula]{формуле Тейлора}
		\begin{equation*}
		...
		\end{equation*}
		\begin{equation*}
		+ \frac{f^{(2n)}(x_0)}{(2n)!} (x - x_0)^{2n} + \frac{f^{(2n+1)}(x_0)}{(2n+1)!} (x - x_0)^{2n+1} + o((x - x_0)^{2n+1}) \Leftrightarrow
		\end{equation*}
		\begin{equation*}
